...
import {useRegisterMutation} from "../../store/slices/userSlice/userApi.ts";
import {useAppSelector} from "../../store/hooks.ts";
import {selectAuthenticated, selectUser} from "../../store/slices/userSlice/userSlice.ts";
            ...
            >
                <div className='bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
                    <form onSubmit={handleSubmit} className='space-y-6'>
                        ...
                        <button
                            type='submit'
                            className='z-30 w-full cursor-pointer flex justify-center py-2 px-4 border border-transparent
