...
import { useGetAnalyticsQuery } from '../../../services/analiticsApi'
...
const AnalyticsTab = () => {
  ...
  useEffect(() => {
    ...
    fetchAnalyticsData()
  }, [data?.analyticsData, data?.dailySalesData])
...
const AnalyticsCard = ({ title, value,  icon:Icon, color } : IAnalyticsProps) => (
  <motion.div
